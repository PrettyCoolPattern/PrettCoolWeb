...
class ChatManagerComponent extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  render() {
    return (
      <Fragment>
        <CardHeader> PCP Chat Manager</CardHeader>
        <CardBody>
          <div
            style={{
          ...
          <button> Delete Message #</button> <br />
          <Input
...
export default ChatManagerComponent;
