              ...
              <Card className="col-md- opacity-9 " >
                <CardHeader className="card-header-tab">
                  <div className="card text-center card-shadow-focus opacity-9">
                    PrettyCoolPattern Services  </div>
                </CardHeader>
                <CardBody>  <div class="col-md">
                  <div class="col-md">
                    Founded on a five point focus system, PCP is a team and network of resources, information, abilities and values, youthfully sprouting into the modern world of technology and revolutionary sciences.
